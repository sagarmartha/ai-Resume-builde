  ...
  return (
    ...
    <ResumeInfoContest.Provider value={{ resumeInfo, setResumeInfo }}>
      ...
      <div className='my-10 mx-10 md:mx-20 lg:mx-36'>
        <h2 className='text-center text-2xl font-medium'>Congrats! Your Ultimate AI generator Resume is ready !</h2>
        <p className='text-center text-gray-500'>Now you are ready to download our reume and you can share unique resume url with your friend and family</p>
